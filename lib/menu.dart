...
class BuildScrollItem extends StatefulWidget {
  final String imgPath, name, price;
  BuildScrollItem({this.imgPath, this.name, this.price});

  @override
  _BuildScrollItemState createState() => _BuildScrollItemState();
}

class _BuildScrollItemState extends State<BuildScrollItem> {
  Color bookMcolor = Colors.orange;
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.all(10.0),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: RawMaterialButton(
                ...
                onPressed: () {
                  setState(() {
                    if (bookMcolor == Colors.orange) {
                      bookMcolor = Colors.green;
                    } else {
                      bookMcolor = Colors.orange;
                    }
                  });
                },
                child: Center(
